...
def get_args():
    ...
    parser.add_argument("--teacher_choice", default='ViT-B/16', help="Teacher model architecture")
    parser.add_argument("--teacher_ckpt", default="", help="Path to fine-tuned teacher model checkpoint folder")
    ...
    parser.add_argument("--distillation", default=False, action='store_true', help="Enable knowledge distillation")
    parser.add_argument("--rel_kd_weight", default=0.1, type=float)
